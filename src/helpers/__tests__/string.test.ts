...
describe('truncateWithPeriod', () => {
  it('제한 길이를 넘지 않는 경우 원본 문자열을 반환합니다.', () => {
  ...
  it('마침표가 없는 경우 제한 길이까지 문자열을 자릅니다.', () => {
  ...
  it('마침표가 있지만 제한 길이 내에 없는 경우 문자열을 제한 길이까지 자릅니다.', () => {
  ...
  it('제한 길이 내 마침표 뒤에 공백 없이 시작하는 문자열이 있는 경우 잘라냅니다.', () => {
    const text =
