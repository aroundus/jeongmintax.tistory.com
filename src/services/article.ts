import { default as likeReactionDeleteMockData } from '@/mocks/fixtures/article/likeReaction.delete.json';
import { default as likeReactionPostMockData } from '@/mocks/fixtures/article/likeReaction.post.json';
import { default as reactionGetMockData } from '@/mocks/fixtures/article/reaction.get.json';
import type { TistoryResponse } from '@/types/global';
